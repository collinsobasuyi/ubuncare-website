        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-textBody leading-relaxed max-w-md">
              Compassionate AI mental health support that fits into your life. Evidence-based
              techniques, private by design.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/blog" className="text-textBody hover:text-primary transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-textBody hover:text-primary transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/guides" className="text-textBody hover:text-primary transition-colors">
                  Guides
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="text-textBody hover:text-primary transition-colors">
                  About
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/press" className="text-textBody hover:text-primary transition-colors">
                  Press
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="flex items-center gap-6 text-sm text-textBody">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="mailto:hello@ubuncare.com"
                  className="hover:text-primary transition-colors flex items-center gap-1"
                >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-textBody leading-relaxed">
                  If you are in crisis or thinking about harming yourself, seek immediate help: US:
                  call or text 988 · UK: 116 123 (Samaritans) · Worldwide:{" "}
                  <a
