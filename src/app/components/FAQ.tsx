        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 max-w-2xl mx-auto">
            ...
            <p className="text-textBody text-sm">
              Ubuncare is designed for educational purposes and self-help support only. 
              It does not provide medical advice, diagnosis, or treatment. 
              Always consult with qualified healthcare professionals for personal mental health needs.
            </p>
          </div>
