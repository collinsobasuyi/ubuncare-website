          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {companions.map((companion) => (
                <div
                  key={companion.name}
                  className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-gray-200"
                >
                  <div className="text-center">
                    <div
                      className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${companion.gradient} flex items-center justify-center shadow-lg`}
                    >
